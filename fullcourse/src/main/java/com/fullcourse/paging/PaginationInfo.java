...
public class PaginationInfo {
    ...
    // 추가: 현재 페이지에 해당하는 데이터 인덱스 반환
    public int getIndexNumPerPage(int statusIndex) {
        return getTotalRecordCount() - (getRecordCountPerPage() * (getCurrentPageNo() - 1)) - statusIndex;
    }
}
